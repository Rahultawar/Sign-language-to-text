...
def preprocess_frame(landmarks):
    ...
    normalized_frame = scaler.transform(features)
    reshaped_frame = np.reshape(normalized_frame, (1, len(features[0]), 1))
...
while True:
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            preprocessed_frame = preprocess_frame(hand_landmarks.landmark)
